...
public class AccomodationController {
	/*
	 * //숙박업소 리스트 // 매핑 경로 : /main/showAccoList public ModelAndView
	 * showList(HttpServletRequest request, AccomodationVO vo) {
	 * 
	 * }
	 * 
	 * // 매핑 경로 : /master/viewAcco public ModelAndView
	 * viewAccomodation(HttpServletRequest request, AccomodationVO vo) {
	 * 
	 * } // 매핑 경로 : /master/editAcco public ModelAndView
	 * editAccomodationForm(HttpServletRequest request, AccomodationVO vo) {}
	 * 
	 * // 매핑 경로 : /master/editOkAcco public ModelAndView
	 * editOkAccomodation(HttpServletRequest request, AccomodationVO vo) {}
	 * 
	 * // 매핑 경로 : /master/viewAcco public ModelAndView
	 * viewAccomodation(HttpServletRequest request, AccomodationVO vo) {}
	 * 
	 * // 매핑 경로 : /master/deleteAcco public ModelAndView
	 * deleteAccomodation(HttpServletRequest request, AccomodationVO vo) {}
	 * 
	 * // 매핑 경로 : /master/insertAcco public ModelAndView
	 * insertAccomodationForm(HttpServletRequest request) {}
	 * 
	 * //가맹점 주인 // 매핑 경로 : /master/insertOkAcco public ModelAndView
	 * insertOkAccomodation(HttpServletRequest request, AccomodationVO vo) {}
	 * 
	 * //숙박업소리스트(전체 관리자) // 매핑 경로 : /webmaster/showAccoList public ModelAndView
	 * showListWebmaster(HttpServletRequest request, AccomodationVO vo) {}
	 */
